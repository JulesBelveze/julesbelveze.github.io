...
$$
\tilde{\Sigma}_{t+1} = U(A_{1:t},\ \tau_{1:t}) \qquad \Sigma_{t+1} = G\Big(\Sigma_t,\ \tilde{\Sigma}_{t+1},\ E\big(\pi_{\theta_t}(\Sigma_t, \cdot),\ \pi_{\theta_t}(\tilde{\Sigma}_{t+1}, \cdot);\ \mathcal{X}\big)\Big)
$$
